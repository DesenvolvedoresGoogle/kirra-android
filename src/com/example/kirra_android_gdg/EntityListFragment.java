...
/**
 * A list fragment representing a list of Entities. This fragment also supports
...
public class EntityListFragment extends ListFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        new AsyncTask<Void, Void, List<Entity>>() {
        	...
        	protected List<Entity> doInBackground(Void... params) {
        		...
        		return entities = schemaManagement.getEntities("expenses");
        	}
	...
	public void onListItemClick(ListView listView, View view, int position,
		...
		if (position >= entities.size())
	       	return;
	   mCallbacks.onItemSelected(entities.get(position));
    }
